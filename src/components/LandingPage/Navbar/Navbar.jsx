    ...
    >
      ...
      <div className="hidden md:flex items-center gap-10">
        ...
        >
          ...
          <div
            className={`absolute top-full left-0 mt-4 min-w-[240px] bg-black border border-zinc-800 shadow-[0_20px_50px_rgba(0,0,0,0.9)] transition-all duration-300 origin-top flex flex-col overflow-hidden ${isDropdownOpen
          ...
          >
            ...
            <Link
              ...
              className="flex items-center px-6 py-5 text-zinc-300 font-inter font-bold uppercase tracking-widest text-sm whitespace-nowrap hover:text-black hover:bg-brand-green transition-all duration-300"
            >
              Fit Pro Alpha Tribe
            </Link>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 bg-brand-black z-[101] transition-transform duration-500 ease-in-out md:hidden flex flex-col pt-32 px-8 pb-12 overflow-y-auto ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col border-b border-zinc-900 pb-6 w-full">
            ...
            <div
              className={`flex flex-col gap-5 overflow-hidden transition-all duration-500 ease-in-out ${isMobileDropdownOpen ? 'max-h-[300px] opacity-100 mt-6' : 'max-h-0 opacity-0 mt-0 pt-0'
                }`}
            >
              <Link
                to="/free-community"
